sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/rizing/demo/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("com.rizing.demo.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/rizing/demo/localService/mockserver"], function (mockserver) {
